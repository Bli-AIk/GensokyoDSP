...
// ============================================================================
// a_freq Tests - 振荡器A音高控制
// ============================================================================

struct AFreqTestCase {
    name: &'static str,
    config_file: &'static str,
    reference_file: &'static str,
    duration: f64,
...
impl AFreqTestCase {
    fn run(&self) -> Result<(), Box<dyn std::error::Error>> {
        let config_path = Path::new("tests/fixtures/a_freq_tests").join(self.config_file);
        let reference_path = Path::new("tests/fixtures/a_freq_tests").join(self.reference_file);
...
// b_form Tests - 振荡器B波形控制（osc_mix=1.0）
struct BFormTestCase {
    name: &'static str,
    config_file: &'static str,
    reference_file: &'static str,
    duration: f64,
...
impl BFormTestCase {
    fn run(&self) -> Result<(), Box<dyn std::error::Error>> {
        let config_path = Path::new("tests/fixtures/b_form_tests").join(self.config_file);
        let reference_path = Path::new("tests/fixtures/b_form_tests").join(self.reference_file);
...
// b_freq Tests - 振荡器B音高控制（osc_mix=1.0）
struct BFreqTestCase {
    name: &'static str,
    config_file: &'static str,
    reference_file: &'static str,
    duration: f64,
...
impl BFreqTestCase {
    fn run(&self) -> Result<(), Box<dyn std::error::Error>> {
        let config_path = Path::new("tests/fixtures/b_freq_tests").join(self.config_file);
        let reference_path = Path::new("tests/fixtures/b_freq_tests").join(self.reference_file);
...
#[test]
fn test_a_freq_0_0547() {
    let test = AFreqTestCase {
        name: "a_freq_0.0547",
...
#[test]
fn test_b_form_0_0547() {
    let test = BFormTestCase {
        name: "b_form_0.0547",
...
#[test]
fn test_b_freq_0_0547() {
    let test = BFreqTestCase {
        name: "b_freq_0.0547",
